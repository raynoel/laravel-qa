        ...
        @foreach ($answers as $answer)
          <div class="media">
            <div class="d-fex flex-column vote-controls">
              ...
              @can ('accept', $answer)                                  <!-- l'auteur de la question peut accepter la réponse -->
                <a title="Mark this answer as best answer" 
                  class="{{ $answer->status }} mt-2"                    {{-- active la classe 'vote-accepted' si cette réponse est la 'best_response_id' --}}
                  onclick="event.preventDefault(); document.getElementById('accept-answer-{{ $answer->id }}').submit();"{{-- click pour soumettre comme la meilleur réponse --}}
                  >
              ...
              @else                                                   <!-- tout le monde peut voir le checkmark vert -->
                @if ($answer->is_best)
